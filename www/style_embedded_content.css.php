...
#content.embedded-mode h1.listing + .post-meta .date {
	position: absolute;
	right: 0;
	bottom: -1px;
	margin: 0;
...
#content.embedded-mode h1.listing + .post-meta .author {
	max-width: 120px;
	overflow: hidden;
	text-overflow: ellipsis;
}
#content.embedded-mode h1.listing + .post-meta .author:hover {
	overflow: visible;
	z-index: 1;
	text-shadow: 
		0 0  1px #fff,
...
#secondary-content-column.collapsed .secondary-content-column-toggle-button {
