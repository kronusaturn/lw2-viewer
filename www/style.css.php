...
.archive-nav:nth-last-child(2) {
	margin-bottom: 5.25em;
}
.archive-nav:last-child::after,
.archive-nav:nth-last-child(2)::after {
...
.user-page .sublevel-nav:nth-last-child(2)::after {
	content: "No entries.";
	display: block;
	margin: 1.25em;
	font-size: 1.375em;
...
#comments-list-mode-selector button.selected:active {
	transform: none;
}
#comments-list-mode-selector button:not(.selected) {
	opacity: 0.4;
}
