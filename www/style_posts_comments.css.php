...
.listings .comment-thread .comment-meta a.date {
	line-height: 1;
	position: relative;
}
.listings .comment-thread .comment-meta a.date:focus::after {
	content: "";
	position: absolute;
	width: calc(100% + 12px - var(--GW-comment-listings-date-focused-adjust-x));
	height: calc(100% + 8px - var(--GW-comment-listings-date-focused-adjust-y));
	left: calc(-6px + var(--GW-comment-listings-date-focused-adjust-x));
	top: calc(-4px + var(--GW-comment-listings-date-focused-adjust-y));
}
...
.comment-item .deep-comment-threshold {
	display: none;
}

.comment-item .deep-comment-threshold ~ .comment-thread > li:first-child {
	margin-top: 0;
}
.comment-item .deep-comment-threshold ~ .comment-thread .comment-thread .comment-item {
	margin: 0;
	border-width: 1px 0 0 0;
}

.comment-item .deep-comment-threshold ~ .comment-thread .comment-thread .comment-item a.comment-parent-link:hover::after {
	display: none;
}
...
@media only screen and (max-width: 520px) {
	...
	#content.compact .comment-item.expanded .comment-meta .nav-links-container,
	#content.compact .comment-thread.expanded .comment-meta .nav-links-container {
		display: flex;
	}
}
...
.comment-meta .permalink:focus::before,
.comment-meta .lw2-link:focus::before,
.comment-meta .comment-parent-link:focus span::before,
.post .post-meta .lw2-link:focus::before {
...
.comment-meta .permalink:focus::after,
.comment-meta .lw2-link:focus::after,
.comment-meta .comment-parent-link:focus span::after,
.post .post-meta .lw2-link:focus::after {
	width: 26px;
	height: 26px;
	left: -5px;
	top: -5px;
