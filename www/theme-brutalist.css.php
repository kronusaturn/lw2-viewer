...
@media only screen and (max-width: 1020px) {
	#anti-kibitzer-toggle {
		...
		box-shadow: 
			0 0 0 2px var(--GW-primary-color),
			0 0 0 10px var(--GW-body-background-color);
	}
}
...
#quick-nav-ui a {
	box-shadow: 
		...
		0 0 0 3px var(--GW-primary-color);
}
...
#quick-nav-ui a:active {
	box-shadow: 
		0 0 0 3px var(--GW-body-background-color) inset,
		0 0 0 5px var(--GW-primary-color) inset,
		0 0 0 1px var(--GW-body-background-color),
		0 0 0 3px var(--GW-primary-color);
}
...
@media only screen and (max-width: 1020px) {
	#quick-nav-ui {
		background-color: var(--GW-body-background-color);
		box-shadow: 0 9px 0 0px var(--GW-body-background-color);
	}
}
