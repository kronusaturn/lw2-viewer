...
:root {
	...
	--GW-comment-item-new-comment-outline-color: var(--GW-C7);
	--GW-comment-item-focused-outline-color: var(--GW-C1);
	--GW-comment-item-higlight-color: var(--GW-C1);
	--GW-comment-item-highlight-faint-color: var(--GW-C4);
...
.answer-item.highlight::after,
.answer-item.highlight-faint::after {
	border-style: solid;
}
...
.comment-minimize-button {
	color: var(--GW-comment-item-outline-color);
	font-weight: 300;
	top: 3px;
}
...
.comment-item.minimized .comment-minimize-button::after {
	top: 18px;
}
...
.vote::before,
.vote.selected:hover::before {
	content: var(--GW-brutalist-vote-button-icon-plain);
}
.vote.selected::before,
.vote:hover::before,
.vote.big-vote:hover::before {
	content: var(--GW-brutalist-vote-button-icon-boxed);
}

.upvote {
	--GW-brutalist-vote-button-icon-plain: "\F067";
	--GW-brutalist-vote-button-icon-boxed: "\F0FE";
}
.downvote {
	--GW-brutalist-vote-button-icon-plain: "\F068";
	--GW-brutalist-vote-button-icon-boxed: "\F146";
}
...
#markdown-hints-checkbox:focus + label {
	box-shadow: none;
}
#markdown-hints-checkbox + label:hover::before,
#markdown-hints-checkbox:focus + label::before,
