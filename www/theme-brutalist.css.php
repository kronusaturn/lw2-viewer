...
:root {
	...
	--GW-body-background-color:
		rgb(
			calc(var(--GW-C0-R) * var(--GW-C0-V)),
			calc(var(--GW-C0-G) * var(--GW-C0-V)),
			calc(var(--GW-C0-B) * var(--GW-C0-V))
		);
	...
	--GW-primary-color:
		rgb(
			calc(var(--GW-C1-R) * var(--GW-C1-V)),
			calc(var(--GW-C1-G) * var(--GW-C1-V)),
			calc(var(--GW-C1-B) * var(--GW-C1-V))
		);
	--GW-C1: var(--GW-primary-color);

	--GW-hyperlink-color: var(--GW-C1);

	--GW-theme-selector-outline-color: var(--GW-C1);
}
...
#bottom-bar.decorative::after {
	...
	color:
		rgb(
			calc(var(--GW-C0-R) * 0.85),
			calc(var(--GW-C0-G) * 0.85),
			calc(var(--GW-C0-B) * 0.85)
		)
}
...
.nav-inner::after {
	...
	color:
		rgb(
			calc(var(--GW-C0-R) * 0.8),
			calc(var(--GW-C0-G) * 0.8),
			calc(var(--GW-C0-B) * 0.8)
		)
}
